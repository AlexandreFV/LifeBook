...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SQLiteDatabase db = dbHelper.getWritableDatabase(); // Isso cria ou abre o banco de dados
    ...
    private void inserirAgrupamento(String nomeAgrupamento, String categoria, String corFundoHex, String corBotoesHex, String corTextoHex) {
        View QuadradoAdicioneAlgo = findViewById(R.id.Fundo_Adicione_Algo);
        TextView AdicioneAlgoText = findViewById(R.id.AdicioneAlgo);
        try {
            DatabaseHelper dbHelper = new DatabaseHelper(this);
            ...
            bancoDados.insert("agrupamento", null, values);
            bancoDados.close();
    ...
    public void salvarAgrupamento() {
        ...
        Log.d("salvarAgrupamento", "Nome: " + nomeAgrupamento);
        Log.d("salvarAgrupamento", "Categoria: " + categoria);
        Log.d("salvarAgrupamento", "Cor de Fundo: " + corFundoHex);
        Log.d("salvarAgrupamento", "Cor dos Botões: " + corBotoesHex);
        Log.d("salvarAgrupamento", "Cor do Texto: " + corTextoHex);


        // Inserir no banco de dados
        inserirAgrupamento(nomeAgrupamento, categoria, corFundoHex, corBotoesHex, corTextoHex);
